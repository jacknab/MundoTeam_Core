Contributing to Mundoteam Core
============================

The Mundoteam Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the Mundoteam Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/mundoteam-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to mundoteam-qt
...
The following applies to code changes to the Mundoteam Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Mundoteam
Network Protocol consensus changes.

Whether a pull request is merged into Mundoteam Core rests with the project merge
...
Patches that change Mundoteam consensus rules are considerably more involved than
...
Where a patch set proposes to change the Mundoteam consensus, it must have been
...
The project leader is the release manager for each Mundoteam Core release.
