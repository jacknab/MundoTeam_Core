# Support for Output Descriptors in Mundoteam Core

Since Mundoteam Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `mnt1...` for mainnet or `tmnt1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
existing Mundoteam Core wallets, a convenience function `combo` is
