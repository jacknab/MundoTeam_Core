...
{
    const char* pszTimestamp = "25 october 2023";
    const CScript genesisOutputScript = CScript() << ParseHex("04ff8314c4cf72627cd5dda9ad6f9e50ee75efdfb8b7137142cd111fc273d311c721d01198b2cd7fadde3b51b5d65e15ff440a0d2f530633c8a853e19f66b4fd55") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.defaultAssumeValid = uint256S("0xac3d7a41656ce8866bef2c21522d7159917ec141e0a606a6e34569d674c4393c"); 
        ...
        genesis = CreateGenesisBlock(1698247347, 1435378, 0x1e0ffff0, 1, 250 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xac3d7a41656ce8866bef2c21522d7159917ec141e0a606a6e34569d674c4393c"));
        assert(genesis.hashMerkleRoot == uint256S("0xbf78c298323070bc47c8690062f5bd8aa227b719017b1d6602d762877b3d3c7b"));
        ...
        vSeeds.emplace_back("mundoteam.dyndns.org");
        ...
        checkpointData = {
            {
                {  0, uint256S("0xac3d7a41656ce8866bef2c21522d7159917ec141e0a606a6e34569d674c4393c")},
            }
        };

        chainTxData = ChainTxData{
            // Data from rpc: getchaintxstats 4096 ac3d7a41656ce8866bef2c21522d7159917ec141e0a606a6e34569d674c4393c
            /* nTime    */ 1698247347,
            /* nTxCount */ 0,
            /* dTxRate  */ 0
        };
...
public:
    CTestNetParams() {
        ...
        consensus.defaultAssumeValid = uint256S("0x17089aa0444d800afc04a5ab0d9d3807832afeec7d005aebac05260eb7f161e7"); 
        ...
        genesis = CreateGenesisBlock(1698247667, 538714, 0x1e0ffff0, 1, 250 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x17089aa0444d800afc04a5ab0d9d3807832afeec7d005aebac05260eb7f161e7"));
        assert(genesis.hashMerkleRoot == uint256S("0xbf78c298323070bc47c8690062f5bd8aa227b719017b1d6602d762877b3d3c7b"));
        ...
        checkpointData = {
            {
                {0, uint256S("17089aa0444d800afc04a5ab0d9d3807832afeec7d005aebac05260eb7f161e7")},
            }
        };

        chainTxData = ChainTxData{
            // Data from RPC: getchaintxstats 4096 17089aa0444d800afc04a5ab0d9d3807832afeec7d005aebac05260eb7f161e7
            /* nTime    */ 1698247667,
            /* nTxCount */ 0,
            /* dTxRate  */ 0,
        };
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlock(1698247790, 0, 0x207fffff, 1, 250 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x965a021294e628653eb485891427855b368a3b244369b75be65356abfc97946f"));
        assert(genesis.hashMerkleRoot == uint256S("0xbf78c298323070bc47c8690062f5bd8aa227b719017b1d6602d762877b3d3c7b"));
        ...
        checkpointData = {
            {
                {0, uint256S("965a021294e628653eb485891427855b368a3b244369b75be65356abfc97946f")},
            }
        };
