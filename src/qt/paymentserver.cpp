...
const QString BITCOIN_IPC_PREFIX("mundoteam:");
    ...
    if (startLocalServer)
    {
        ...
        if (!uriServer->listen(name)) {
            ...
            QMessageBox::critical(nullptr, tr("Payment request error"),
                tr("Cannot start mundoteam: click-to-pay handler"));
        }
        else {
...
void PaymentServer::handleURIOrFile(const QString& s)
{
    ...
    if (s.startsWith("mundoteam://", Qt::CaseInsensitive))
    {
        Q_EMIT message(tr("URI handling"), tr("'mundoteam://' is not a valid URI. Use 'mundoteam:' instead."),
    ...
    else if (s.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // bitcoin: URI
    {
        ...
        // normal URI
        {
            ...
            if (GUIUtil::parseBitcoinURI(s, &recipient))
            {
                ...
                Q_EMIT message(tr("URI handling"),
                    tr("URI cannot be parsed! This can be caused by an invalid Mundoteam address or malformed URI parameters."),
                    CClientUIInterface::ICON_WARNING);
