...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " mundoteam-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  mundoteam-tx [options] <hex-tx> [commands]  Update hex-encoded mundoteam transaction\n" +
            "or:     mundoteam-tx [options] -create [commands]   Create hex-encoded mundoteam transaction\n" +
            "\n";
