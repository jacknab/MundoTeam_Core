...
bech32_templates = [
  ...
  ('mnt',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('mnt',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('mnt',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('mnt',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('tmnt',    0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tmnt',    0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tmnt',    1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('tmnt',    3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('tmnt',    0, 20, (False, 'signet',  None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tmnt',    0, 32, (False, 'signet',  None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tmnt',    1, 32, (False, 'signet',  None, True), Encoding.BECH32M, p2tr_prefix),
  ('tmnt',    3, 32, (False, 'signet',  None, True), Encoding.BECH32M, (OP_3, 32)),
  ('rmnt',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('rmnt',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('rmnt',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('rmnt', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
...
bech32_ng_templates = [
  ...
  ('tmnt',   17, 32, Encoding.BECH32M, False, False, False),
  ('rmnt',  3,  1, Encoding.BECH32M, False, False, False),
  ('mnt',   15, 41, Encoding.BECH32M, False, False, False),
  ('tmnt',    0, 16, Encoding.BECH32,  False, False, False),
  ('rmnt',  0, 32, Encoding.BECH32,  True,  False, False),
  ('mnt',    0, 16, Encoding.BECH32,  True,  False, False),
  ('tmnt',    0, 32, Encoding.BECH32,  False, True,  False),
  ('rmnt',  0, 20, Encoding.BECH32,  False, False, True),
  ('mnt',    0, 20, Encoding.BECH32M, False, False, False),
  ('tmnt',    0, 32, Encoding.BECH32M, False, False, False),
  ('rmnt',  0, 20, Encoding.BECH32M, False, False, False),
  ('mnt',    1, 32, Encoding.BECH32,  False, False, False),
  ('tmnt',    2, 16, Encoding.BECH32,  False, False, False),
  ('rmnt', 16, 20, Encoding.BECH32,  False, False, False),
]
